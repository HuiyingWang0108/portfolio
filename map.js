...
function initMap() {
  ...
  const contentString1 =
    ...
    "</div>" +
    '<div id="bodyContent">' +
    "<p><b>Xinyang</b> is where I was born, in a small town. I was the first girl in our village to go to university. I am lucky because I have an awesome mother who always encourages me. She believes that knowledge and hard work can change life: Do your best, prepare for the worst. I was admitted to the university with the second-highest rank in high school.where I was born in a small town here. " +
  ...
  const contentString4 =
    ...
    "</div>" +
    '<div id="bodyContent">' +
    "<p><b>Merced, US</b>, where I sought to achieve the American dream by stepping out of my comfort zone. I resigned from my position as a software engineer and embarked on a journey into the unknown. " +
  ...
  const contentString5 =
    ...
    "</div>" +
    '<div id="bodyContent">' +
    "<p><b>Bellevue, US</b>, where I got my full stack web developer certification from UW. I am committed to continuous learning and personal development, as I believe in the importance of ongoing education." +
    '<img src="./images/certification.jpeg" alt="born in here" width="100%" height="80%">' +
    'Known HTML, XML, JSON, CSS3, BootStrap4, JavaScript, jQuery, Ajax, Node.js, python3, git, ' +
